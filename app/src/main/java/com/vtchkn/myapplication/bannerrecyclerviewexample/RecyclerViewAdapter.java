...
class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * {@link MenuItem} and {@link PublisherAdView} types.
     */
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (viewType) {
            ...
            default:
                ...
                PublisherAdView adView = (PublisherAdView) recyclerViewItems.get(position);
                ViewGroup adCardView = (ViewGroup) bannerHolder.itemView;
                // The AdViewHolder recycled by the RecyclerView may be a different
                // instance than the one used previously for this position. Clear the
                // AdViewHolder of any subviews in case it has a different
                // PublisherAdView associated with it, and make sure the PublisherAdView for this position doesn't
